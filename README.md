API BOX（官方网站: https://www.geek-block.com） 是一款由北京智博万维科技有限公司提供的产品，专为提 供线下API服务而设计。它可以帮助您轻松构建本地API服务应用，有以下优点：
...
2、本公司高度重视用户信息保护本公司郑重承诺，不会通过本公司服务及软件保留用户环境敏感信息（如设 备IP、设备基础软硬件版本、设备账户密码等）  
